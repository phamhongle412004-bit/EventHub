...
public class GlobalExceptionHandler {
    ...
    // 1. Ánh xạ lỗi Validation (@Valid / @Validated) (400 Bad Request)
    ...
    // 3. Ánh xạ lỗi Tham số không hợp lệ từ Service / IllegalArgumentException (400 Bad Request)
    ...
    // 4. Ánh xạ lỗi Không tìm thấy tài nguyên (404 Not Found)
    ...
    // 5. Ánh xạ lỗi Trùng lặp dữ liệu (409 Conflict)
    ...
    // 6. Ánh xạ các lỗi Quy tắc Nghiệp vụ / Xung đột Trạng thái (409 Conflict)
    ...
    // 7. Ánh xạ lỗi Sai thông tin đăng nhập (401 Unauthorized)
    ...
    // 8. Ánh xạ lỗi Không có quyền truy cập (403 Forbidden)
    ...
    // 9. Xử lý an toàn các lỗi hệ thống không lường trước (500 Internal Server Error)
